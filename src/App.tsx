      ...
      <div className="Main">
        ...
        <Habilidades
          itens={[
            ...
            { title: 'Tailwind', src: 'Imagens/tailwind.svg', alt: 'Framework Tailwind CSS', link: 'https://tailwindcss.com/' },
        ...
        <Projetos
          projetos={[
            { title: 'Serenatto', src: './Imagens/project_serenatto-cafe.png', website: 'https://serenatto-ebon.vercel.app/', github: 'https://github.com/httpE2Barao/Code-study/tree/main/Bootstrap', description: 'O projeto é um site informativo e elegante sobre a cafeteria Serenatto, usando e aprimorando minhas habilidades com o framework Bootstrap. O site consiste na apresentação dos produtos da cafeteria, como cafés especiais, bolos, salgados e vitaminas. Também possui um botão para alternar entre o tema claro e o modo escuro, criando uma atmosfera mais aconchegante e intimista. O objetivo é oferecer uma experiência única e diferenciada para os clientes.' },
            { title: 'Turismo Espacial', src: './Imagens/project_space-tourism.png', website: 'https://turismo-espacial-xi.vercel.app/', github: 'https://github.com/httpE2Barao/SpaceTourism', description: 'Este projeto é uma aplicação web que apresenta informações sobre uma missão espacial. Ele utiliza o React para construir a interface do usuário e oferece recursos avançados, como os Hooks, para gerenciar o estado e os efeitos colaterais. O projeto utiliza técnicas de otimização, como a pré-renderização de imagens, para garantir um carregamento rápido e uma experiência fluida para o usuário. O código do projeto segue boas práticas de organização e estruturação, tornando-o fácil de entender e dar manutenção.' },
