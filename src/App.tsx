      ...
      <div className="Main">
        ...
        <Habilidades
          itens={[
            ...
            { title: 'JQuery', src: 'Imagens/jquery.svg', alt: 'Biblioteca JQuery', link: 'https://jquery.com/' },
          ]}
        />
